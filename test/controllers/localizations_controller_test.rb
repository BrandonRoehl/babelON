...
class LocalizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localization" do
    assert_difference('Localization.count') do
      post localizations_url, params: { localization: { content: @localization.content, lang: @localization.lang, message_id: @localization.message_id } }
    end
  ...
  test "should update localization" do
    patch localization_url(@localization), params: { localization: { content: @localization.content, lang: @localization.lang, message_id: @localization.message_id } }
